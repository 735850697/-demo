...
- (void)initNotificationCenter{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(selectIndex:) name:clickIndex object:nil];
}
...
- (void)removeNotificationCenter{
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:clickIndex object:nil];
}
...
//选择的那个标签按钮
- (void)selectIndex:(NSNotification *)notif{
    ...
    CGFloat offX = index * self.rootScrollView.width;
    [self buttonMoveAnimationWithIndex:index];
    [self.rootScrollView setContentOffset:CGPointMake(offX, 0) animated:NO];
    
    [[NSNotificationCenter defaultCenter] postNotificationName:choseBtn object:nil];
