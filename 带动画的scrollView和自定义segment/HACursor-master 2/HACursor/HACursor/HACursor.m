...
@property (nonatomic, strong) HATableView *sortItmView;
...
-(HATableView *)sortItmView{
    if (!_sortItmView) {
        _sortItmView = [[HATableView alloc]init];
...
- (void)setup{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(sortButtonClick) name:choseBtn object:nil];
}
